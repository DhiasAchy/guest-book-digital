				...
				<div class="row">
					<div class="col-12">
						<div class="card m-b-30">
							<div class="card-body">
								<h4 class="mt-0 header-title">Edit Achievement</h4>
								...
								<input type="hidden" name="id" value="<?= $achievement['id'] ?>">
									<div class="form-group bmd-form-group">
										...
										<input type="text" class="form-control" name="title" value="<?= $achievement['name'] ?>" id="exampleInputEmail1">
									</div>
									<div class="form-group bmd-form-group">
										<img src="<?= base_url($achievement['image']) ?>" class="img img-fluid" style="width: 150px;" alt="">
									</div>
									<div class="form-group bmd-form-group">
										<label for="exampleInputEmail1" >Image</label>
										<input type="file" class="form-control" name="image" value="" id="exampleInputEmail1">
									</div>
