				...
				<div class="row">
					<div class="col-12">
						<div class="card m-b-30">
							<div class="card-body">
								<h4 class="mt-0 header-title">Tambah Company</h4>
								...
								<?= form_open_multipart(base_url(array_slice(explode('/', uri_string()), 0, -1)) . '/insert'); ?>
								    <div class="row">
								        <div class="col-12">
								            <div class="form-group bmd-form-group">
        										<label for="InputName">Nama Company</label>
        										<input type="text" class="form-control" name="company" value="" id="InputName">
        									</div>
								        </div>
