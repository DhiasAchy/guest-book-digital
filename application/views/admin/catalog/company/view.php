                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                <h4 class="mt-0 header-title">Data Company</h4>
                                <a class="btn btn-primary border-0 d-none" href="<?= base_url(uri_string() . '/add'); ?>" role="button"><i class="mdi mdi-account-multiple-plus"></i> Tambah
                                        ...
                                        foreach ($company as $key => $value) {
                                            ...
                                            <tr id="<?= $value['id']; ?>">
                                                ...
                                                <td class="text-center">
                                                    <a href="<?= base_url($value['pdf']) ?>" target="_blank">
                                                        <img src="<?= base_url($value['image_cover']) ?>" width="50" alt="">
                                                    </a>
                                                </td>
                                                <td><?= $value['created_at']; ?></td>
                                                <td class="text-center">
                                                    <a href="<?= base_url('admin/catalog/company/edit/' . $value['id'] . ''); ?>" class="btn btn-primary border-0"><i class="fas fa-edit"></i>
                                                        <div class="ripple-container"></div>
                                                    </a>
...
<script>
    ...
    $(document).ready(function() {
        ...
        if(data_error==0) {
            ...
            .then((value) => {
                window.location.replace("https://wirawan.web.id/ebook/ci/admin/catalog/company");
            });
        }
