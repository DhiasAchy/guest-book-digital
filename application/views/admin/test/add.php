					...
					<div class="col-12">
						<div class="card m-b-30">
							<div class="card-body">
								...
								<!--<form class="mb-0" action="<?= base_url(array_slice(explode('/', uri_string()), 0, 2)) . '/insert'; ?>" id="form-add" method="POST" enctype="multipart/form-data">-->
								<?= form_open_multipart(base_url(array_slice(explode('/', uri_string()), 0, 2)) . '/insert_'); ?>
								    <div class="row">
								        ...
								        <div class="col-12">
								            <div class="form-group bmd-form-group">
        										<label for="InputName" class="bmd-label-floating ">Nama</label>
